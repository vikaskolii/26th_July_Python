...
c="VikasKoli"
print("Vik" in c)               # Chcek the the words in the string.
...
print(d1.count("tejinkar")) #occcurence count
...
print(str7.count("my")) # Checking the occurence in string
